...
const KEY_LABEL: Record<string, string> = {
    ...
    disabledChildCount: "Số trẻ em khuyết tật",
    partyMemberCount: "Số đảng viên",
    unionMemberCount: "Số đoàn viên/hội viên",
    martyrCount: "Số liệt sĩ",
    martyrFamilyCount: "Số gia đình liệt sĩ",
    veteranCount: "Số cựu chiến binh",
    otherSpecialCount: "Số diện ưu tiên khác",
...
const ReportsContent: React.FC = () => {
    ...
    // o backend (xem cac route trong api/reports/**) - truoc day danh sach tab
    // lai loc theo TEN VAI TRO cu the (admin/to truong/canh sat khu vuc), nen
    // mot vai tro khac (vd bi thu) du duoc admin cap them "reports.read" qua
